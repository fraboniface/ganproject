...
# save everything
torch.save(G.state_dict(), RESULTS_FOLDER + 'cifar_conditional_generator_{}epochs'.format(n_epochs))
torch.save(D.state_dict(), RESULTS_FOLDER + 'cifar_conditional_discriminator_{}epochs'.format(n_epochs))
results = {
	'loss_d': loss_d,
