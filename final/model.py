...
class Generator(nn.Module):
    def __init__(self, input_dim, n_feature_maps=64):
...
class ACDiscriminator(nn.Module):
    def __init__(self, n_class1, n_class2, num_features=n_feature_maps):
        ...
        self.class1_logits = nn.Conv2d(n_feature_maps, n_class1, 1, 1, 0, bias=False)
        self.class2_logits = nn.Conv2d(n_feature_maps, n_class2, 1, 1, 0, bias=False)
    ...
    def  forward(self, x, fm=False, only_fm=False):
    	...
    	class1_logits = self.class1_logits(x).view(-1, n_class1)
    	class2_logits = self.class2_logits(x).view(-1, n_class2)
