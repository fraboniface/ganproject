...
# save everything
torch.save(G.state_dict(), RESULTS_FOLDER + 'cifar_cGAN_generator_{}epochs'.format(n_epochs))
torch.save(D.state_dict(), RESULTS_FOLDER + 'cifar_cGAN_discriminator_{}epochs'.format(n_epochs))
results = {
	'D_loss': loss_d,
...
with open(RESULTS_FOLDER + 'losses_and_samples_cifar_cGAN.p', 'wb') as f:
